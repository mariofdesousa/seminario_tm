...
Na aplicação sobre depressão iremos considerar os dícionários de sentimentos **afinn**(@afinn2011), **bing**(@bing2005) e **nrc**(@nrc2013), por estarem disponíveis no R.
